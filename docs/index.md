...
<div style="text-align: center; margin-bottom: 2rem;">
  <img src="assets/img/word_embedding_3d.gif" alt="Word Embeddings 3D" style="width: 100%; max-width: 700px; border-radius: 12px;">
  <p style="font-size: 0.85rem; color: var(--md-default-fg-color--light); margin-top: 0.5rem;">
...
flowchart TD
    subgraph "Ontem"
        A1[Humano executa tudo]
    end
    
    subgraph "Hoje"
        B1[IA como assistente<br/>Otimiza tarefas]
    end
    
    subgraph "Amanhã"
        C1[Agentes autônomos<br/>sob orientação humana<br/>executam processos completos]
    end
    
    subgraph "Depois"
        D1[Operações conduzidas por agentes<br/>Humanos como estrategistas,<br/>decisores e designers de sentido]
    end
    
    A1 --> B1 --> C1 --> D1
    
    style A1 fill:#666,color:#fff
    style B1 fill:#2196f3,color:#fff
    style C1 fill:#7c4dff,color:#fff
    style D1 fill:#ff6d00,color:#000
```
